...
var initial_public_stats_loaded = 0;
var post_loaded = 0;
var wager_contest_winners = null;
var current_page_tab = "free_play";
$.ajaxSetup({
    data: {
...
$(document).ready(function() {
    ...
    $(".homepage_play_now_button").click(function(event) {
        window.location.replace("https://freebitco.in/static/html/one_click_signup_new.html?r=" + referrer_in_url + "&tag=" + referrer_tag);
    });
    ...
    if (userid > 0) {
        ...
        $(document).on("click", function(event) {
            ...
            target_id.replace(/\s+/g, '');
            if (typeof target_id == undefined || target_id == null || target_id.length < 3) {
                target_id = $(event.target).text();
            }
            if (target_id.length > 0) {
                ga('send', 'event', current_page_tab, 'click', target_id, {
        ...
        $('#fbtc_userbase_img').attr("src", "https://sirv.freebitco.in/1574253847_If3WnVV8.png");
        $('#fbtc_games_played_img').attr("src", "https://sirv.freebitco.in/1574253982_ImYCkaiy.png");
        $('#fbtc_btc_won_img').attr("src", "https://sirv.freebitco.in/1574253604_qV3999Sg.png");
        $('body').css('background-image', 'url(https://sirv.freebitco.in/1574230692_Lsa9Jyc9.jpg)');
        $(window).scroll(function() {
            if (post_loaded < 1) {
                $('#home_free_btc_img').attr("src", "https://sirv.freebitco.in/1574167743_eh5ja4W1.png");
                $('#home_btc_dice_img').attr("src", "https://sirv.freebitco.in/1574253404_gZhJZ2XC.png");
                $('#home_ref_contest_img').attr("src", "https://sirv.freebitco.in/1574167858_VQHw8AK4.png");
                $('#home_wager_contest_img').attr("src", "https://sirv.freebitco.in/1574167905_PE2uccRv.png");
                $('#home_interest_img').attr("src", "https://sirv.freebitco.in/1574167765_KenJoFmp.png");
                $('#home_pari_img').attr("src", "https://sirv.freebitco.in/1574167796_t3VSITIS.png");
                $('#home_lottery_img').attr("src", "https://sirv.freebitco.in/1574167929_Yq2Me6O6.png");
                $('#home_aff_program_img').attr("src", "https://sirv.freebitco.in/1574167828_NR2bVK8T.png");
                $('#home_win_lambo_img').attr("src", "https://sirv.freebitco.in/1574253131_6hnDF9tJ.png");
                if ($('body').innerWidth() < 626) {
                    $('.lambo_bg_div').css('background-image', 'url(https://sirv.freebitco.in/1574410850_RSnDjCCb.png)');
                } else {
                    $('.lambo_bg_div').css('background-image', 'url(https://sirv.freebitco.in/1574168109_grDMPZpF.jpg)');
                }
                post_loaded = 1;
            }
        });
...
function UpdateUserStats() {
    if (socket_userid > 0) {
        ...
        setTimeout(UpdateUserStats, 7.5 * 60 * 1000);
    }
}
...
function SwitchPageTabs(tab_name) {
    ...
    if (tab_name == "golden_ticket") {
        ...
        $('#golden_ticket_lambo_main_image').attr("src", "https://sirv.freebitco.in/1588206672_UtVElxC0.jpg");
    ...
    if (tab_name == "stats" || tab_name == "rewards" || tab_name == "golden_ticket") {
        InitialStatsLoad();
    }
    ...
    $.get('/cf_stats_public/?f=updating2', function(data) {
        if (typeof data != 'undefined') {
            if (data.status == "success") {
                ...
                if (typeof data.deposit_promo_ends !== 'undefined' && data.deposit_promo_ends > 0 && data.deposit_promo_ends > epoch_time) {
                ...
                } else if (epoch_time > data.double_lambo_start && epoch_time < data.double_lambo_end) {
                    var img_link = "https://sirv.freebitco.in/1589617329_3k8YBqsV.jpg";
                    if ($('body').innerWidth() < 769) {
                        if (new_user_first_load == 0) {
                            $("#deposit_promo_message_mobile").show();
                        }
                    } else {
                        img_link = "https://sirv.freebitco.in/1589617343_FP0a0XRD.jpg";
                        if (new_user_first_load == 0) {
                            $("#deposit_promo_message_regular").show();
                        }
                    }
                    ...
                    $('.deposit_promo_time_remaining').countdown('destroy');
                    $('.deposit_promo_time_remaining').countdown({
                        until: +(data.double_lambo_end - epoch_time),
                        format: 'HMS'
                    });
                    ...
                    $("#multiply_free_golden_tix").parent().css({
                        'font-weight': 'bold'
                    });
                } else {
...
function InitialStatsLoad() {
    if (initial_public_stats_loaded == 0) {
        $.get('/cf_stats_public/?f=public_stats_initial', function(data) {
            if (typeof data != 'undefined') {
                if (data.status == "success") {
                    ...
                    if (parseInt(data.previous_lambo_winner.round) > 0) {
                        var mobile_class_one = "";
                        if ($('body').innerWidth() < 769) {
                            mobile_class_one = " lottery_table_mobile_style ";
                        }
                        $('#previous_lambo_lottery_winners_list_div').html('<div class="large-12 small-12 columns center lottery_winner_table_box table_header_background br_5_5"><div class="center" style="margin:auto;">ROUND ' + data.previous_lambo_winner.round + '</div></div><div class="large-12 small-12 columns center lottery_winner_table_box"><div class="center bold" style="margin:auto;">TOTAL TICKETS: ' + ReplaceNumberWithCommas(data.previous_lambo_winner.total_tickets) + '</div></div><div class="large-12 small-12 columns center lottery_winner_table_box_container effect2"><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_first_last_cell' + mobile_class_one + '"><span class=bold>USER ID</span></div><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_third_cell' + mobile_class_one + '"><span class=bold>AMOUNT WON</span></div><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_first_last_cell' + mobile_class_one + '"><span class=bold>USER TICKETS</span></div></div><div class="large-12 small-12 columns center bold lottery_winner_table_box_container effect2"><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_first_last_cell' + mobile_class_one + '"> ' + data.previous_lambo_winner.userid + ' </div><div class="large-4 small-4 columns center bold lottery_winner_table_box lottery_winner_table_third_cell' + mobile_class_one + '"> <i class="fa fa-btc"></i>&nbsp;' + parseFloat(parseInt(data.previous_lambo_winner.amount) / 100000000).toFixed(8) + ' </div><div class="large-4 small-4 columns center bold lottery_winner_table_box lottery_winner_table_first_last_cell' + mobile_class_one + '"> ' + ReplaceNumberWithCommas(data.previous_lambo_winner.tickets_purchased) + ' </div></div>');
                    }
                }
            }
...
function PreviousContestWinners(round_number) {
    if (round_number > 0) {
        if (wager_contest_winners == null) {
            $.get('/cf_stats_public/?f=wager_contest_winners', function(data) {
                wager_contest_winners = data;
            });
            var wager_contest_winners_interval = setInterval(function() {
                if (wager_contest_winners != null) {
                    clearInterval(wager_contest_winners_interval);
                    PreviousContestWinners(round_number);
                }
            }, 100);
        } else {
            ...
            for (var x = 1; x < 11; x++) {
                for (var i = 0; i < wager_contest_winners.length; i++) {
                    if (wager_contest_winners[i].rank == x) {
                        if (wager_contest_winners[i].round == round_number) {
                            if (wager_contest_winners[i].contest_type == "wager") {
                                var prize = parseFloat(Math.round((wager_contest_winners[i].prize / 100000000) * 100000000) / 100000000).toFixed(8);
                                var wagered = parseFloat(Math.round((wager_contest_winners[i].wagered / 100000000) * 100000000) / 100000000).toFixed(8);
                                $("#contest_winner_table_user_list").append('<div class="large-12 small-12 columns center lottery_winner_table_box_container effect2"><div class="large-1 small-1 columns center lottery_winner_table_box lottery_winner_table_first_last_cell ' + mobile_class + '"> ' + wager_contest_winners[i].rank + ' </div><div class="large-3 small-3 columns center lottery_winner_table_box lottery_winner_table_second_cell ' + mobile_class + '"> ' + wager_contest_winners[i].userid + ' </div><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_third_cell ' + mobile_class + '"> <i class="fa fa-btc" aria-hidden="true"></i> ' + prize + '</div><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_first_last_cell ' + mobile_class + '"> <i class="fa fa-btc" aria-hidden="true"></i> ' + wagered + ' </div></div>');
                            } else if (wager_contest_winners[i].contest_type == "ref") {
                                var prize = parseFloat(Math.round((wager_contest_winners[i].prize / 100000000) * 100000000) / 100000000).toFixed(8);
                                var wagered = parseFloat(Math.round((wager_contest_winners[i].wagered / 100000000) * 100000000) / 100000000).toFixed(8);
                                $("#contest_winner_table_referrer_list").append('<div class="large-12 small-12 columns center lottery_winner_table_box_container effect2"><div class="large-1 small-1 columns center lottery_winner_table_box lottery_winner_table_first_last_cell ' + mobile_class + '"> ' + wager_contest_winners[i].rank + ' </div><div class="large-3 small-3 columns center lottery_winner_table_box lottery_winner_table_second_cell ' + mobile_class + '"> ' + wager_contest_winners[i].userid + ' </div><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_third_cell ' + mobile_class + '"> <i class="fa fa-btc" aria-hidden="true"></i> ' + prize + '</div><div class="large-4 small-4 columns center lottery_winner_table_box lottery_winner_table_first_last_cell ' + mobile_class + '"> <i class="fa fa-btc" aria-hidden="true"></i> ' + wagered + ' </div></div>');
                            }
                        }
                    }
                }
